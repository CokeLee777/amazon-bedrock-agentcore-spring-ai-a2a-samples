 ...
 * when {@code spring.ai.chat.memory.repository.bedrock.agent-core.memory.memory-id} is
 * set. When the property is absent, Spring AI's {@code InMemoryChatMemoryRepository} is
 * used as a fallback via {@code ChatMemoryAutoConfiguration}.
 * </p>
 */
@NullMarked
